      ...
      <el-main style="overflow: hidden">
        ...
        <div>
          ...
          <SearchComponent :key="renderKey" search-title="规格型号" :searchContent=spec ref="search2" field="spec"
            @search="search" @edit="edit" />
          <SearchComponent :key="renderKey" search-title="供料单位" :searchContent=spec ref="search2" field="unit"
            @search="search" @edit="edit" />
        ...
        <el-table :data="tableShown.value" style="width: 100%; border-radius: 1vh" table-layout="fixed" height="48vh"
          ...
          <el-table-column prop="undesirable" label="不良数量" align="center" />
          <el-table-column prop="reuse" label="返用数量" align="center" />
          <el-table-column prop="scrap" label="报废数量" align="center" />
          <el-table-column prop="unit" label="供料单位" align="center" />
          <el-table-column prop="operation" label="处理记录" align="center">
            <!-- <template #default="scope">
              ...
              <div class="flex justify-space-between flex-wrap gap-4">
                <el-button style="color:rgb(114, 159, 208)" link>查看</el-button>
              </div>
          </el-table-column>
