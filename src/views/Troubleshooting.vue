...
import { getTroubleshootingRecordAPI, addTroubleshootingRecorAPI } from "../apis/troubleshooting"
    ...
    <dv-border-box1 ref="borderRef" class="subNavPage animate__animated animate__zoomIn" :color="['#4f698794', '#4f698794']"
        ...
        <el-container class="subNavPage">
          ...
          ">
                ...
                <!-- 弹框区 -->
                <!-- 新增弹框 -->
                <DialogComponent ref="addDialog-1" :form="addform" dialog-title="新增故障维修记录" :refreshFunc="getDataFromAPI"
                    ...
                    <el-form-item label="故障内容" prop="error" :rules="[
                        { required: true, message: '请输入故障描述内容', trigger: 'blur' },
                        {
                            min: 1, max: 300,
                            message: '长度必须在1-30之间', trigger: 'blur'
                        }]">
                        <el-input v-model="addform.error" autocomplete="off" placeholder="请输入故障描述内容" />
                    </el-form-item>
                </DialogComponent>
                ...
                <DialogComponent ref="addDialog" :form="stockform" dialog-title="新增故障维修记录" :refreshFunc="getDataFromAPI"
                    :confirm-func="addTroubleshootingRecorAPI" @dialogClose="dialogClose" :image=true @saveImage=saveImage>
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="设备名称" prop="name" :rules="[
