...
const folderList = ref(['a', 'b', 'c', 'd'])
const fileList = ref(['桁架机械手维护手册', '翻转机维护手册', '激光切割机维护手册', '搬运机器人维护手册', '焊接机械臂桁架维护手册', '焊接机器人维护手册', '焊接夹具维护手册'])
const checkList = ref([])

const setAttachment = () => {
  addform.attachment = JSON.stringify(checkList)
}
      ...
      <el-main style="overflow: hidden">
        ...
        <DialogComponent ref="addDialog" :form="addform" dialog-title="新增设备" :refreshFunc="getDataFromAPI"
          ...
          <el-form-item prop="attachment" label="附件" :rules="[
            ...
            color: #729fd0;
            width: fit-content;
            cursor: pointer" @click="linkDialog = true">关联文件</div>
        ...
        <el-dialog v-model="linkDialog" title="关联文件" width="40%" :before-close="linkClose">
          ...
          <div style="margin:2vh">
            ...
            color: #729fd0;
            width: fit-content;
            cursor: pointer" @click="updateFileList">{{ item }}</div>
        ...
        <el-table :data="tableData.value" @selection-change="handleSelectionChange"
          ...
          <el-table-column prop="operation" label="操作" align="center" min-width="90vh">
