...
<template>
    ...
    <dv-border-box1 ref="borderRef" class="subNavPage animate__animated animate__zoomIn"
        ...
        <el-container class="subNavPage">
                ...
                <div v-if="!userStore.isReadOnly" style="display: flex; justify-content: space-between">
                    <span>
                        <el-button type="primary" @click="addDialog.dialogVisible = true, dialog = true">
                            <Plus style="width: 1em; height: 1em; margin-right: 8px" />新增成本项
                        </el-button>
            ...
            cursor: pointer;
          ">
                    <RouterLink to="/cost/consumable">耗材管理</RouterLink>
                    <RouterLink style="margin-left: 2vh;" to="/cost/worker">人工管理</RouterLink>
                    <RouterLink style="margin-left: 2vh;" to=" /inventory/operation">操作记录</RouterLink>
                </div>
                ...
                <!-- 出库弹框 -->
                <DialogComponent ref="stockOutDialog" :form="stockform" dialog-title="物料出库"
                    :refreshFunc="getDataFromAPI" :confirm-func="addMaterialOperationAPI" @dialogClose="dialogClose"
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="物料名称" prop="name">
                                <DialogSearch :key="renderKey" :wNo="100" search-title="物料名称"
                                    :searchContent=stockform.name field="name" @search="dialogSearchSuggestion"
                                    :data="stockform" database="materials/operation" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                ...
                <!-- 转库弹框 -->
                <DialogComponent ref="transferDialog" :form="stockform" dialog-title="转入不良物料"
                    :refreshFunc="getDataFromAPI" :confirm-func="addMaterialOperationAPI" @dialogClose="dialogClose"
                    :image=true @saveImage=saveImage>
                    <el-row>
                        <el-col :span="12">
                ...
                <el-table :data="tableData.value" @selection-change="handleSelectionChange"
                    ...
                    <el-table-column v-for="product in productData" :key="product" :label="product" align="center">
                    ...
                    <el-table-column prop="amount" label="综合" align="center" />
