...
const disabledDate = (day) => {
    return day < new Date(stockform.plannedTime);
}
        ...
        <el-container class="subNavPage">
            ...
            <div style="display: flex;justify-content: center;">
                <el-breadcrumb separator="/">
                    <el-breadcrumb-item :to="{ path: '/maintenancePlan/maintenanceList' }">
                        <h1>设备维护信息</h1>
                    </el-breadcrumb-item>
                    <el-breadcrumb-item>
                        <h1>详情</h1>
            ...
            <el-main style="overflow: hidden">
                <!-- search -->
                <!-- <div>
                    <SearchComponent :key="renderKey" search-title="工段名称" :searchContent=section ref="search3"
                        field="section" @search="search" @edit="edit" database="maintenance" :wNo=10 />
                ...
                <div style="display: flex; justify-content: space-between">
                    <!-- <span>
                        ...
                        <ExportButton v-model="selectedRows" :headers="headers" :tableData="tableData.value"
                            fileName="设备维护信息.xlsx" :filterFunction="filterExportData" buttonLabel="导出" />
                    </span>
                    <span>

                        <el-button
                            @click="dailyDialog = true, dialog = true, getDefaultDate(), getDailyPlan()">日常保养</el-button>
          ...
          ">
                    ...
                    <el-card v-for="(item, index) in    dailyList   ">
                        <el-form :model="item" @submit.prevent label-position=right>
                            <el-row>
                                <el-col :span="12">
                                    <el-form-item label="设备名称" prop="name">
                                        <el-input v-model="item.name" autocomplete="off" disabled
                                            style="margin-right:1vh" />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                    <el-form-item label="规格型号" prop="spec">
                                        <el-input v-model="item.spec" autocomplete="off" disabled
                                            style="margin-right:1vh" />
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
                                <el-col :span="12">
                                    <el-form-item label="工段名称" prop="section">
                                        <el-input v-model="item.section" autocomplete="off" disabled
                                            style="margin-right:1vh" />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                    <el-form-item label="设备编号" prop="serialNo">
                                        <el-input v-model="item.serialNo" autocomplete="off" disabled
                                            style="margin-right:1vh" />
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="上次维护日期" prop="prevDailyTime">
                                        <el-date-picker v-model="item.prevDailyTime" type="datetime"
                                            value-format="YYYY-MM-DDTHH:mm:ss" disabled style="margin-right:1vh" />
                                    </el-form-item>
                                </el-col>
                            </el-row>

                            <el-form-item label="维护内容" prop="info">
                                <el-input v-model="item.info" autocomplete="off" placeholder="请填写维护内容"
                                    style="margin-right:1vh" />
                            </el-form-item>
                        </el-form>
                    </el-card>
                ...
                <div>
                    <el-card style="width: 100%;margin-bottom: 1vh;">
                        ...
                        <div style="height: 4vh;line-height: 4vh;">
                            维护类型：{{ stockform.type }}</div>
                        <div style="height: 4vh;line-height: 4vh;">
                            计划完成维护时间：{{ stockform.plannedTime.substring(0, 10) }} {{ stockform.plannedTime.substring(11,) }}
                        </div>
                    ...
                    <el-card style="width: 100%;">
                        ...
                        <div style="height: 4vh;line-height: 4vh">
                            维护结果：{{ stockform.status }}</div>
                        <div style="height: 4vh;line-height: 4vh;">
                            维护人员：{{ stockform.maintenanceman ? stockform.maintenanceman : '' }}</div>
                        <div style="height: 4vh;line-height: 4vh;">
                            完成维护日期：{{ stockform.completeTime ? stockform.completeTime.substring(0, 10) : '' }} {{
                                stockform.completeTime ? stockform.completeTime.substring(11,) : '' }}</div>
                        <div style="height: 4vh;line-height: 4vh;">
                            维护内容：{{ stockform.info ? stockform.info : '' }}</div>
                    </el-card>
