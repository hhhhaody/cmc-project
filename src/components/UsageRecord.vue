    ...
    async getData(station) {
      ...
      if (station === '总装工作站') {
        ...
        res.data = [
          ...
          { name: ' E#模块箱3号墙板', spec: 'CMC:03:E#:01:QB03:041（102600）+040（F1.1#.8F）', outbound: 24, usage: 8, 总装工作站: 8 },
          ...
          { name: ' E#模块箱楼承板', spec: 'CMC:03:E#:01:LB::041（102600）+040（F1.1#.8F）', outbound: 18, usage: 7, 总装工作站: 7 },
        ...
        res.data = [
          ...
          { name: ' E#模块结构系统1号墙板加筋桁架04', spec: 'CMC:04:E#:01:QB01:HJ01::096（180*30*10*2）+097（2440）:1:30-03.30.20.10:041（102600）+040（F1.1#.8F）', outbound: 11, usage: 7, 墙板生产线: 7 },
